...
extension Date {
    ...
    */
    ...
    func toString(style:DateStyleType = .short, locale: Locale = Locale.current) -> String {
        switch style {
        case .short:
            return self.toString(dateStyle: .short, timeStyle: .short, isRelative: false, locale: locale)
        case .medium:
            return self.toString(dateStyle: .medium, timeStyle: .medium, isRelative: false, locale: locale)
        case .mediumDateShortTime:
            return self.toString(dateStyle: .medium, timeStyle: .short, isRelative: false, locale: locale)
        case .long:
            return self.toString(dateStyle: .long, timeStyle: .long, isRelative: false, locale: locale)
        case .longDateOnly:
            return self.toString(dateStyle: .long, timeStyle: .none, isRelative: false, locale: locale)
        case .full:
            return self.toString(dateStyle: .full, timeStyle: .full, isRelative: false, locale: locale)
        case .ordinalDay:
    ...
    /// Creates a new date with adjusted components by adding/subtracting offset
    ...
    /// Creates a new date with the components by setting the value
    
    func update(_ component:DateComponentType, value:Int) -> Date {
        var dateComp = Date.components(self)
        switch component {
            case .second:
...
enum DateFormatType {
    ...
    /// App specific format date i.e. "dd/MM/yyyy"
    case appDate
    
    /// App specific format date i.e. "yyyy-MM-dd HH:mm:ss.SSS"
    case appDateTime
    ...
    var stringFormat:String {
        ...
        case .appDate: return "dd/MM/yyyy"
        case .appDateTime: return "yyyy-MM-dd HH:mm:ss.SSS"
...
enum DateStyleType {
    ...
    case medium
    /// mediumDateShortTime style: "Feb 27, 2017, 2:22 PM"
    case mediumDateShortTime
    /// Long style: "February 27, 2017 at 2:22:06 PM EST"
    case long
    ///Long Date only style: "February 27, 2017"
    case longDateOnly
