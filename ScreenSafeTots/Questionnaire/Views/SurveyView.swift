        ...
        VStack {
            ...
            Button(action: { selectChoice(choice) }, label: {
                ...
                Text( choice.text )
                    ...
                    .foregroundColor( choice.selected ? Color.black : Theme.Color.label.suColor )
                ...
                HStack {
                    ...
                    Button(action: { self.takeSurveyTapped() }, label: {
                        Text("Take the Survey")
                            .font(.system(size: 15.dynamic, weight: .semibold))
                            .padding(6.0)
                    }).buttonStyle(CustomButtonStyle(bgColor: Theme.Color.primary.suColor))
                        .padding(5)
            ...
            VStack {
                ...
                Button(action: { submitSurveyTapped() }, label: {
                    Text("Submit Survey")
                        .font(.system(size: 15.dynamic, weight: .semibold))
                        .padding(6.0)
                }).buttonStyle(CustomButtonStyle(bgColor: Theme.Color.primary.suColor)).padding()
